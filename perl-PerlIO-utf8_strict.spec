...
%prep
%setup -q -n PerlIO-utf8_strict-0.010
cd %{_builddir}
tar xf %{_sourcedir}/libperlio-utf8-strict-perl_0.007-2.debian.tar.xz
cd %{_builddir}/PerlIO-utf8_strict-0.010
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/PerlIO-utf8_strict-0.010/deblicense/
...
cp %{_builddir}/PerlIO-utf8_strict-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-PerlIO-utf8_strict/8f053a2dacee0e891a03be98ca05fd2fffba2632 || :
cp %{_builddir}/debian/copyright %{buildroot}/usr/share/package-licenses/perl-PerlIO-utf8_strict/08ebc7804c285da0aafadfe4f9c897fc80c62519 || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-PerlIO-utf8_strict/08ebc7804c285da0aafadfe4f9c897fc80c62519
