...
cd %{_builddir}/PerlIO-utf8_strict-0.007
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/PerlIO-utf8_strict-0.007/deblicense/
...
cp %{_builddir}/PerlIO-utf8_strict-0.007/LICENSE %{buildroot}/usr/share/package-licenses/perl-PerlIO-utf8_strict/fa89be48cbebd856e7cb66d4c21f0b6f4ea67aee
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/PerlIO/utf8_strict.pm
/usr/lib/perl5/vendor_perl/5.30.3/x86_64-linux-thread-multi/auto/PerlIO/utf8_strict/utf8_strict.so
